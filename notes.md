...
Kabob -> Manage Keys -> Add Key ... Auto Download; 
 {select secret} -> `+NEw Version` -> Upload; & check off "disable previous versions"



Downloaded other ancillary data sets - 
- Restaurant Inspections
- Demographic data at the neighborhood level
- Evictions
- 


Create bucket historic_data_manually_managed/ in `sbh-nycitibike-pipeline-gcsdlb-rides-p01/aux_data`
...
- Added new dict
-- Same columns? -> Rename
-- New Columns -> Drop, create table, add data
-- 
